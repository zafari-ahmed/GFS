                        ...
                        <?php $total = 0;$deleteClass = 'color: white;background-color: #283747;';if(@$trasactions){ foreach($trasactions as $data):?>
                            ...
                            <tr style="<?php echo $color?>">
                                ...
                                <td>
                                    ...
                                    <?php if($status !=0){?>
                                        <a target="_blank" class="performTask" href="<?php echo Yii::app()->baseUrl?>/api/messages/type/<?php echo $typeMsg?>/id/<?php echo str_replace('#', '', $data->transaction_number)?>"><span title="<?php //echo $this->getTransactionMessage(str_replace('#', '', $data->transaction_number),$typeMsg)?>" data-type="<?php echo $typeMsg ?>" data-tran="<?php echo (str_replace('#', '', $data->transaction_number))?>" class="label label-primary getMsg">Transaction Message</span></a>
                                    <?php }?>
                                   <a  href="<?php echo Yii::app()->baseUrl?>/booking/deletetransaction/id/<?php echo $data->id?>/type/<?php echo $typeMsg?>"><span class="label label-danger">Delete</span></a>&nbsp;
                                </td>
