                                    ...
                                    <tbody>
                                        <?php $paymentmodesT = $paymentmodesCustomT = 0;foreach($this->paymentScheduleModes() as $modes):?>
                                            <tr>
                                                ...
                                                <td><input class="form-control col-md-3" placeholder="<?php //echo $modes?> Amount" value="<?php //echo number_format($paymentmodes[strtolower($modes)]['amount'])?>" data-rel="<?php //echo $paymentmodes[strtolower($modes)]['amount']?>" readonly></td>
