<div class="row">
    <div class="col-lg-12">
        <h1 class="page-header">Old Transactions</h1>
        <?php
    ...
    <div class="col-lg-12">
        <div class="panel panel-default">
            <div class="panel-heading">
                Plot Old Transaction

            </div>
            <div class="panel-body">
                <div class="row">
                    <form id="transactionOldForm" name="transactionOldForm" role="form" method="POST" action="<?php echo Yii::app()->baseUrl?>/booking/saveoldtransaction">
                        ...
                        <div class="col-lg-12 form-group" id="paymentModeBox">
                            <div class="modeSBoxOrig">
                                <div class="col-lg-4" style="padding-left: 0px;">
                                    <label>Plot Payment Mode</label>
                                    <select name="mode[]" id="modeOld" class="form-control modesSOld" required>
                                        <option value="">Please select plot payment mode</option>
                                        <?php foreach(@$paymentmodes as $mode):?>
                                ...
                                <div class="form-group col-lg-3">
                                    ...
                                    <input type="number" class="form-control" name="transaction[]" placeholder="Transaction Number" autocomplete="off" value="" required>
                                </div>
...
<script>
const form = document.getElementById("transactionOldForm");
