                	...
                	<form target="_blank" role="form" method="POST" action="<?php echo Yii::app()->baseUrl?>/booking/save" enctype="multipart/form-data">
	                	<!-- <div class="col-lg-12"> -->
                                ...
                                <div class="form-group col-lg-3">
                                    ...
                                    <select name="block_number" id="block_number" class="form-control">
                                        ...
                                        <?php foreach($blocks as $block):?>
                                            <option value="<?php echo $block->block_number?>"><?php echo $block->block_number?></option>
                                        <?php endforeach;?>
                                    </select>
                                </div>
                            ...
                            <div class="col-lg-12">
                                ...
                                <div class="form-group col-lg-3">
                                    ...
                                    <!--</select>-->
                                    <input class="form-control" id="monthlyMonths" name="monthlyMonths" placeholder="Monthly Plan" value="60">
                                    <!-- <p class="help-block">Example block-level help text here.</p> -->
                                </div>
                                <div class="form-group col-lg-3">
                            ...
                            <div class="col-lg-12">
                                ...
                                <!--    <input class="form-control" id="agent_commission" name="agent_percentage" placeholder="Agent Commission" value="0" readonly>-->
                                <!--</div>-->
                                ...
                                <div class="form-group col-lg-3">
                                    ...
                                    <input class="form-control calender" id="monthly_start_date" name="monthly_start_date" placeholder="Monthly Start Date" value="<?php echo date('d-m-Y',strtotime(date('d-m-Y')."+1 month"))?>">
                                </div>
                            </div>
	                	<!-- </div> -->
	                    ...
	                    <div class="col-lg-12">
                            ...
                            <div class="form-group">
                                <label>File ID</label>
                                <input class="form-control" id="id" name="id" placeholder="File ID">
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group col-lg-6" style="padding-right: 0px;">
                                ...
                                <input class="form-control calender" id="dob" name="dob" placeholder="Date of Birth" value="<?php echo date('m-d-Y')?>">
                            </div>
                            <div class="form-group">
                                <label>CNIC</label>
                            ...
                            <!-- <div class="col-lg-12 form-group"> -->
		                		<div class="form-group col-lg-4" style="padding-left: 0px;">
	                                ...
	                                <input class="form-control numbersOnly" name="phone" placeholder="Res Phone #" maxlength="20" value='0'>
	                                <!-- <p class="help-block">Example block-level help text here.</p> -->
	                            </div>
	                            <div class="form-group col-lg-4">
	                                <label>Office Phone #</label>
	                                <input class="form-control numbersOnly" name="office" placeholder="Office Phone #" maxlength="20" value='0'>
	                                <!-- <p class="help-block">Example block-level help text here.</p> -->
	                            </div>
	                            <div class="form-group col-lg-4" style="padding-right: 0px;">
	                                <label>Mobile Phone #</label>
	                                <input class="form-control numbersOnly" name="mobile" placeholder="Mobile Phone #" maxlength="20" value='0'>
	                                <!-- <p class="help-block">Example block-level help text here.</p> -->
	                            </div>
		                	<!-- </div> -->
		                	<div class="form-group">
                                <label>Email</label>
                                <input class="form-control" id="email" name="email" placeholder="Email" type="hidden" value="email@email.com">
                            </div>
                            <div class="form-group" >
                            ...
                            <div class="form-group col-lg-6" style="padding-left: 0px;">
                                ...
                                <input class="form-control calender"  name="createdOn" placeholder="Created Date" autocomplete="off" required value="<?php echo date('d-m-Y')//date('Y-m-d')?>">
                            </div>
                            <div class="hide">
                            ...
                            <div class="col-lg-12 form-group hide">
