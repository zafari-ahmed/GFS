        ...
        <div class="panel panel-default">
            <div class="panel-heading" style="height: 55px;">
               ...
               <span class="pull-right" style="display:inline-flex;">
                ...
                &nbsp;
                <span style="margin-top: -5px;"><a href="<?php echo Yii::app()->baseUrl?>/booking/getledgerdetail?monthlyCount=0-3"><span class="label label-<?php echo (@$_GET['monthlyCount'])?'success':'warning'?> btn-sm">Monthly Dues</span></a></span>
