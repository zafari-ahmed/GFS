...
<?php
$oldLetters = array_slice($oldLetters, -3); 
?>
<body>
    <div class="main container" style="padding-top: 200px;">
        <div style="text-align: center;border: 2px solid #000/*#1A5276*/;border-radius: 5px;margin-left: 35%;position: absolute;top: 10%;font-size: 20px;padding: 10px;font-weight: bold;color:#000/*#1A5276*/">Record Copy</div>
