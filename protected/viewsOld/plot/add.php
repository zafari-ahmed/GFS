                    ...
                    <form role="form" method="POST" action="<?php echo Yii::app()->baseUrl?>/plot/save" enctype="multipart/form-data">
                        <!-- <div class="col-lg-12"> -->
                            ...
                            <div class="form-group col-lg-3">
                                ...
                                <input class="form-control"  name="plot_type" placeholder="Plot Type" value="">
                                <!-- <p class="help-block">Example block-level help text here.</p> -->
                            </div>
                            ...
                            <div class="form-group col-lg-6" >
                                ...
                                <input class="form-control" name="discount" id="discount" placeholder="Discount " value="0">
                            </div>
                        <!-- </div> -->
                        <div class="col-lg-12">
...
<?php /*?>
                             <div class="form-group col-lg-12 hide" style="padding-left: 0px;">
