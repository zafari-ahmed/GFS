...
<body>
    ...
    <div class="mainT container">
        <div class="container contentT">
            ...
            <p style="margin-left: -5%;font-size: 11px!important;font-weight: 100;width: 110%;">
            ...
            <p>
                <ol style="width: 110%;margin-left: -9%;font-size: 11px!important;font-weight: 100;">
                    <li>
                ...
                <table style="width: 100%;" border="0">
                    <tr>
                        <td class="terms" style="text-align: left; width: 25%;padding-bottom: 10px;font-weight: bold;font-size: 13px;">
                            Date : <span class="terms" style="width: 70%;"></span>
                        </td>
                        <td class="terms" style="text-align: center;font-weight: bold; width: 150%;padding-bottom: 10px;font-weight: bold;font-size: 10px;line-height: 7px; padding-left: 45%;">
                            <br>
                            
                            <span class="terms" style="width:135%;margin-left: -18%;"></span> 
                            <br><br>
