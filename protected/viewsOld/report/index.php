                        ...
                        <!-- <div class="col-lg-12"> -->
                            <div class="form-group col-lg-3" >
                                ...
                                <?php if($userModel['user_type']['id'] == 1 || $userModel['user_type']['id'] == 5){?>
                                    <input class="form-control calenderr" name="start_date" value="<?php echo isset($_POST['start_date'])?@$_POST['start_date']:date('Y-m-d');?>" autocomplete="off" required>
                                <?php } else {?>
                                    <input class="form-control" name="start_date" value="<?php echo date('Y-m-d')?>" autocomplete="off" required>
                                <?php }?>
                            ...
                            <div class="form-group col-lg-3">
                                ...
                                <?php if($userModel['user_type']['id'] == 1 || $userModel['user_type']['id'] == 5){?>
                                    <input class="form-control calenderr" name="end_date" value="<?php echo isset($_POST['end_date'])?@$_POST['end_date']:date('Y-m-d');?>" autocomplete="off"  required>
                                <?php } else {?>
                                    <input class="form-control" name="end_date" value="<?php echo date('Y-m-d')?>" autocomplete="off"  required>
                                <?php }?>
                            ...
                            <div class="form-group col-lg-2">
                                ...
                                <select name="transaction_type" id="transaction_type" class="form-control" required>
                                    ...
                                    <option <?php echo (@$_POST['transaction_type']=='other')?'selected':''?> value="other">Other</option>
