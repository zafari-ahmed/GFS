    ...
    <div class="col-lg-12">
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <div class="row">
                    <form role="form" method="POST" action="<?php echo Yii::app()->baseUrl?>/report/dealerreportsearch">
                        <!-- <div class="col-lg-12"> -->
                            ...
                            <div class="form-group col-lg-2">
                                <button type="submit" class="btn btn-success" name="form" style="margin-top: 9%;">Submit</button>
                                <button type="submit" class="btn btn-info" name="csv" style="margin-top: 9%;">CSV Download</button>
                            </div>
                        <!-- </div> -->
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body" id="tableBody">
                <table width="100%" class="table table-striped table-bordered table-hover" id="report2table">
                    ...
                    <tbody>
                        <?php $total = 0;$commission = 0;if(@$model){ foreach($model as $ind=>$data):?>
                            <tr>
                                ...
                                <td><?php echo 'Rs. '. $this->Percentage($data->amount,$data->plot->agent_percentage) ?></td>
                                <?php $commission = $commission + $this->Percentage($data->amount,$data->plot->agent_percentage,0);?>
                ...
                <table width="100%" class="table table-striped table-bordered table-hover" id="report2table">
                    ...
                    <tr style="font-weight: bold;">
                       ...
                       <td style="width: 15%"><?php echo 'Rs. '.number_format(@$commission)?></td>
                        <td style="width: 5%"><form role="form" method="POST" action="<?php echo Yii::app()->baseUrl?>/expenses/adddealercommision"><input type="hidden"class="form-control" name="start_date" value="<?php echo @$_POST['start_date'] ?? date('Y-m-d')?>" autocomplete="off" required><input type="hidden"class="form-control" name="end_date" value="<?php echo @$_POST['end_date'] ?? date('Y-m-d')?>" autocomplete="off" required><input type="hidden"class="form-control" name="agent" value="<?php echo @$_POST['agent']?>" autocomplete="off" required><div class="form-group col-lg-2"><button type="submit" class="btn btn-success" style="margin-top: 9%;">Add Comission</button></div></form></td>
                   </tr>
               </table>
                <?php }?>
            </div>
