...
<div class="row">
    ...
    <div class="col-lg-4 col-md-6">
        <div class="panel panel-green">
            ...
            <a href="<?php echo Yii::app()->baseUrl.'/plot?status=0'?>">
                <div class="panel-footer">
                    <span class="pull-left">View Details</span>
                    <span class="pull-right"><i class="fa fa-arrow-circle-right"></i></span>
                    <div class="clearfix"></div>
    ...
    <div class="col-lg-3 col-md-6">
        <div class="panel panel-red">
            ...
            <a href="<?php echo Yii::app()->baseUrl.'/report/blocked'?>">
                <div class="panel-footer">
                    <span class="pull-left">View Details</span>
                    <span class="pull-right"><i class="fa fa-arrow-circle-right"></i></span>
                    <div class="clearfix"></div>
    ...
    <div class="col-lg-3 col-md-6">
        <div class="panel panel-red">
            ...
            <a href="<?php echo Yii::app()->baseUrl.'/report/cancelled'?>">
                <div class="panel-footer">
                    <span class="pull-left">View Details</span>
                    <span class="pull-right"><i class="fa fa-arrow-circle-right"></i></span>
                    <div class="clearfix"></div>
        ...
        <div class="panel panel-red">
            <div class="panel-heading">
                <div class="row">
                    ...
                    <div class="col-xs-9 text-right">
                        <div class="huge">
                            <?php echo 'PKR '. number_format(CustomerPlotCancelled::model()
                                ->getDbConnection()
                                ->createCommand()
                                ->select('SUM(amount)')
                                ->from(CustomerPlotCancelled::model()->tableName())
                                ->queryScalar()); ?>
                        </div>
...
<?php if($userModel['user_type']['id'] == 1 || $userModel['user_type']['id'] == 5){?>
    ...
    <div class="col-lg-2 col-md-6">
        <div class="panel panel-yellow">
            ...
            <a href="<?php echo Yii::app()->baseUrl.'/agent'?>">
                <div class="panel-footer">
                    <span class="pull-left">View Details</span>
                    <span class="pull-right"><i class="fa fa-arrow-circle-right"></i></span>
                    <div class="clearfix"></div>
    ...
    <div class="col-lg-6 col-md-6">
        <div class="panel panel-green">
            ...
            <a href="<?php echo Yii::app()->baseUrl.'/transactions'?>">
                <div class="panel-footer">
                    <span class="pull-left">View Details</span>
                    <span class="pull-right"><i class="fa fa-arrow-circle-right"></i></span>
                    <div class="clearfix"></div>
    ...
    <div class="col-lg-6 col-md-6">
        <div class="panel panel-red">
            ...
            <a href="<?php echo Yii::app()->baseUrl.'/transactions?status=0'?>">
                <div class="panel-footer">
                    <span class="pull-left">View Details</span>
                    <span class="pull-right"><i class="fa fa-arrow-circle-right"></i></span>
                    <div class="clearfix"></div>
     ...
     <div class="col-lg-6 col-md-6">
        <div class="panel panel-yellow">
            ...
            <a href="<?php echo Yii::app()->baseUrl.'/booking/getledgerdetail'?>">
                <div class="panel-footer">
                    <span class="pull-left">View Details</span>
                    <span class="pull-right"><i class="fa fa-arrow-circle-right"></i></span>
                    <div class="clearfix"></div>
    ...
    <div class="col-lg-6 col-md-6">
        <div class="panel panel-green">
            ...
            <a href="<?php echo Yii::app()->baseUrl.'/booking/indexsale'?>">
                <div class="panel-footer">
                    <span class="pull-left">View Details</span>
                    <span class="pull-right"><i class="fa fa-arrow-circle-right"></i></span>
                    <div class="clearfix"></div>
                ...
                <div class="row">
                    ...
                    <div class="col-xs-9 text-right">
                        <?php $expenseTotal = Expenses::model()->findAll(array(
                          'select'=>'SUM(amount) as total_sum',
                          'condition'=>"expense_type != 15 AND status = 1 AND phase_id = $phase_id"));?>
                        <div class="huge" style="font-size: 30px!important"><?php echo 'PKR '.number_format((@$stats[0]['amount']+@$statsExtra[0]['amount'])-$expenseTotal[0]->total_sum);?></div>
                        <div>Liquid Assets</div>
                    </div>
                </div>
            </div>
            <a href="<?php echo Yii::app()->baseUrl.'/expenses/accounts'?>">
                <div class="panel-footer">
                    <span class="pull-left">View Details</span>
                    <span class="pull-right"><i class="fa fa-arrow-circle-right"></i></span>
                    <div class="clearfix"></div>
        ...
        <div class="panel panel-red">
            <div class="panel-heading">
                <div class="row">
                    ...
                    <div class="col-xs-9 text-right">
                        <?php $expenseTotal = PettyCashExpenses::model()->findAll(array(
                          'select'=>'SUM(amount) as total_sum',
                          'condition'=>"status = 1 AND phase_id = $phase_id"));?>
                        <div class="huge" style="font-size: 30px!important"><?php echo 'PKR '.number_format(@$expenseTotal[0]->total_sum);?></div>
                        <div>PettyCash Expense</div>
                    </div>
                </div>
            </div>
            <a href="<?php echo Yii::app()->baseUrl.'/expenses/accounts'?>">
