            ...
            <div class="panel-body">
                <table width="100%" class="table table-striped table-bordered table-hover" id="report2table" style="margin-bottom: 5%">
                    <thead>
                        <tr>
                            ...
                            <th style="background-color: #ffff00">Transactions(Other)</th>
                            <th style="background-color: #ff9800">Expenses(Other)</th>
                            <th style="background-color: #8bc34a">Balance(Other)</th>
                            <!-- <th>Total</th> -->
                ...
                ">  <thead>
                        <tr>
                            ...
                            <th>Expenses(Cash)</th>
                            <th>Balance(Cash)</th>
                            <th>Transactions(Other)</th>
                            <th>Expenses(Other)</th>
                            <th>Balance(Other)</th>
                            <!--<th>(Previous)<br/>PettyCash</th>-->
