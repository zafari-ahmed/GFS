...
class Plots extends CActiveRecord
{
	...
	public function relations()
	{
		...
		return array(
			'customerPlotsRand' => array(self::HAS_MANY, 'CustomerPlots', 'plot_id'),
			...
			'plotsB' => array(self::STAT, 'Plots', 'plot_id', 'select'=>'COUNT(*)','condition'=>'status = 1'),
			'plotsA' => array(self::STAT, 'Plots', 'plot_id', 'select'=>'COUNT(*)','condition'=>'status = 0'),
		);
	}
