                    ...
                    <table class="table table-responsive" style="FONT-SIZE: 12PX;">
                        <tbody>
                            <tr>
                                ...
                                <td><span><?php echo @$booking->special->name?> - Custom PS</span></td>
                            </tr>
                            <tr>
                                <td class="tbBold">Cost of Land Only: </td>
                                <td><?php echo 'Rs. '.number_format($booking->plot->total)?></td>
                            </tr>
                            
                            <tr>
                                <td class="tbBold">Discount: </td>
                                <td><?php echo 'Rs. '.number_format($booking->plot->total-$booking->customPaymentScheduleTotal())?></td>
                            </tr>

                            <tr>
                                <td class="tbBold">Discounted Cost of Land Only: </td>
        ...
        <div class="row">
            ...
            <div class="col-lg-12">
                <div class="table-responsive">
                    <table class="table table-responsive" style="FONT-SIZE: 12PX;">
                        <tbody>
                            <?php if(!$booking->customerpaymentSchedule){ if($modes){
                                ...
                                endforeach;
                            } } else { foreach($modes as $index=>$mode):
                                    echo '<tr><td class="tbBold">'.ucfirst($mode->mode).'</td><td><span class="label label-success" style="text-decoration: none;">'.number_format(round($mode->amount)).'/=</span></td></tr>';
                            ...
                            <table class="table table-hover dataTable no-footer duesTable" border=2 id="duesTable" style="FONT-SIZE: 09PX;margin-bottom: 0px;">
                                ...
                                <tr>
                                    ...
                                    <?php if(($upM+$origPaidM) >= 36){?>
                                        <td><b><?php echo 36-$origPaidM ?> Month(s)</b></td>
                                    <?php } else{?>
                            ...
                            <?php if($checkValue != 6 && $isDetailShowYearly == 1){?>
                                ...
                                <tr>
                                    ...
                                    <?php if(($upHY+$origPaidHY) >=6){?>
                                        <td><b><?php echo 6-$origPaidHY ?> Half Yearly(s)</b></td>
                                    <?php } else{?>
        ...
        <table class="table table-hover dataTable no-footer duesTable" border=1 style="FONT-SIZE: 11PX;margin-bottom: 0px;">
            <thead>
                <tr>
                    ...
                    <th style="background-color: lightgrey!important;line-height: 15px!important;">Reference #</th>
            ...
            <tbody>
                ...
                <?php } endforeach;} ?>
                    <tr class="total" style="background-color: lightgrey!important;color: #000;font-weight: bold;">
                        <td colspan="7" style="background-color: lightgrey!important;">Total</td>
