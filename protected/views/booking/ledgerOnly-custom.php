...
<div class="col-lg-12 infoBox hide" style="margin-top: 5%!important;">
    <div class="hide" style="margin-top:-5%">
...
//echo '<pre>';print_r($paymentmodes);exit;
?>
    ...
    $isDetailShowYearly = 1;
                        ...
                        <td>
                            <?php if($var_sum->total >= $modes->amount){?>
                                <table class="table table-hover dataTable no-footer duesTable hide" border="2" id="duesTable" style="FONT-SIZE: 09PX;margin-bottom: 0px;">
                                  <tbody>
                                    <tr>
                            ...
                            <table class="table table-hover dataTable no-footer duesTable hide" border=2 id="duesTable" style="FONT-SIZE: 09PX;margin-bottom: 0px;">
                                ...
                                <?php if($netTotalCheck >= 0){?>
                                    ...
                                    <td class="hide" colspan="2" style="text-align: center;line-height: 15px!important;"><?php echo '<p><b>'.$checkValue.'</b> out of <b>36</b> monthly installments,';
                                        if($checkValue!=0){
                                            $checkValuePaid = $checkValue-1;
                                ...
                                <tr class="hide">
                                    ...
                                    <?php if(($upM+$origPaidM) >= 36){?>
                                        <td><b><?php echo $upMV = 36-$origPaidM ?> Month(s)</b></td>
                                    <?php } else{?>
                                        <td><b><?php echo $upMV = $upM ?> Month(s)</b></td>
                                    <?php }?>
                                </tr>
                                <?php $result['monthlyDue'] = $upMV?>
                                <tr>
                                    ...
                                    <td class="hide" style="line-height: 5px!important;"><p>Next Due Monthly Installment</p><p><span>(<?php echo number_format(($modes->amount/36),'2','.','')." x $cccC  "?>)</span></p></td>
                                    <td class="hide"><b><?php echo number_format($cccC * number_format(($modes->amount/36),'2','.',''),'2','.',',')?></b></td>
                        ...
                        <?php } elseif($modes->mode=='yearly'){?>
                            ...
                            <?php if($checkValue != 6 && $isDetailShowYearly == 1){?>
                                ...
                                <?php if($netTotalCheck >= 0){?>
                                <td class="hide" colspan="2" style="text-align: center;line-height: 15px!important;">
                                ...
                                <tr>
                                    ...
                                    <td class="hide" style="line-height: 5px!important;"><p>Next Due Half Yearly</p><p><span>(<?php echo number_format(($modes->amount/6),'2','.','')." x $cccC  "?>)</span></p></td>
                                    <td class="hide"><b><?php echo number_format($cccC * number_format(($modes->amount/6),'2','.',''),'2','.',',')?></b></td>
                                    <?php //$result['yearly'] = number_format($cccC * number_format(($modes->amount/6),'2','.',''),'2','.',',')?>
                                </tr>
                        ...
                        <?php }?>
                        <td class="hide"><?php echo 'Rs. '.number_format(@$modes->amount) ?>
                        ...
                        <!--Rec Amount-->
                        <td class="hide"> <?php echo (@$var_sum->total)?'Rs. '.@number_format(@$var_sum->total):'-';?></td>
                        <?php $received = $received + ((@$var_sum->total)?$var_sum->total:0); ?>
                        <?php $rowBalance = @$modes->amount - @$var_sum->total;?>
                        
                        <!--Balance Amount-->
                         <td class="hide"><?php echo (@$var_sum->total )?'Rs. '.number_format(@$rowBalance):'Rs. '.number_format($modes->amount)?></td>
                        <?php $balance = $balance + @$rowBalance;?>
                    </tr> 
                <?php endforeach; ?>
                
                <tr class="hide" style="font-size: 12px;">
                    <td>Plot Extra</td>
                    <td>-</td>
                ...
                <!-- <tr class="total hide" style="background-color: lightgrey!important;color: #000;font-weight: bold;">
