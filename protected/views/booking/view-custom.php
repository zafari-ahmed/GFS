...
// exit;
$det = $this->getPlotLedgerDetailCustom($booking->id);
?>
<div class="row">
    <div class="col-lg-12">
        ...
        <?php if($userModel['user_type']['id'] == 1 || $userModel['user_type']['id'] == 5 || $userModel['user_type']['id'] == 4 || $userModel['user_type']['id'] == 3){?>
            <?php if(empty($booking->customerPlotCancelled) && $booking->status!=3){?>  
                    ...
                    &nbsp;&nbsp;<span class="pull-right" style="margin-right: 10px;"><a href="<?php echo Yii::app()->baseUrl?>/booking/editbooking/<?php echo $booking->id?>"><button type="button" class="btn btn-primary btn-sm">Edit Booking</button></a>&nbsp;&nbsp;
                        <a href="<?php echo Yii::app()->baseUrl?>/paymentschedule/customschedule/id/<?php echo $booking->id?>"><button type="button" class="btn btn-primary btn-sm">Custom Payment Schedule</button></a></span>&nbsp;&nbsp;</span>&nbsp;&nbsp;
                    <?php if($userModel['user_type']['id'] == 1){?>
        ...
        <div class="panel panel-<?php echo ($booking->status==1)?'success':'danger'?>">
            ...
            <div class="panel-body">
                ...
                <div class="col-lg-12">
                    ...
                    <?php $tpp = $booking->customPaymentScheduleTotal();?>
                        ...
                        <table width="100%" class="table table-striped table-bordered table-hover">
                            ...
                            <tbody>
                                <tr class="hide">
                                    ...
                                    <?php }?>
                                    <td><?php echo 'Rs. '.number_format($booking->customPaymentScheduleTotal())?></td>
                                </tr>
                                ...
                                <tr>
                                    <td>Is Corner</td>
                                    <td><?php echo @$booking->plot->is_corner_amount?>% - <?php echo 'Rs. '.$this->Percentage($tpp,$booking->plot->is_corner_amount)?></td>
                                    <?php $tpp += $this->Percentage($tpp,$booking->plot->is_corner_amount,false)?>
                                </tr>
                                <?php } ?>
                                ...
                                <tr>
                                    <td>Park Facing </td>
                                    <td><?php echo @$booking->plot->is_park_facing_amount?>% - <?php echo 'Rs. '.$this->Percentage($tpp,$booking->plot->is_park_facing_amount)?></td>
                                    <?php $tpp += $this->Percentage($tpp,$booking->plot->is_park_facing_amount,false)?>
                                </tr>
                                <?php } ?>
                                ...
                                <tr>
                                    <td>West Open</td>
                                    <td><?php echo @$booking->plot->is_west_open_amount?>% - <?php echo 'Rs. '.$this->Percentage($tpp,$booking->plot->is_west_open_amount)?></td>
                                    <?php $tpp += $this->Percentage($tpp,$booking->plot->is_west_open_amount,false)?>
                                </tr>
                                <?php } ?>

                                
                               <tr style="background-color: lightgray;"><td><b>Total Extra Charges Applicable</b></td><td><b><?php echo 'Rs. '.number_format($tpp-$booking->customPaymentScheduleTotal())?></b></td></tr>
                            </tbody>
                        </table>
                    </div>
                    <?php }?>
            ...
            <div class="panel-body">
                <table width="100%" class="table table-bordered table-hover">
                    ...
                    <tbody>
                       ...
                       <tr><td colspan="3"><b>Discount</b></td><td colspan="9"><b><?php echo 'Rs. '.number_format($booking->plot->total-$booking->customPaymentScheduleTotal())?></b></td></tr>
                       <tr><td colspan="3"><b>Discounted Total Cost of Land</b></td><td colspan="9"><b><?php echo 'Rs. '.number_format($booking->customPaymentScheduleTotal())?></b></td></tr>
                       ...
                       <?php if($booking->status==3){?>
                        ...
                        <tr><td colspan="3"><b>Balance</b></td><td colspan="9"><b><?php echo 'Rs. '.number_format($booking->customPaymentScheduleTotal()-$booking->customerPlotTransactionSumTransfer)?></b></td></tr>
                       <?php } else {?>
                        <tr><td colspan="3"><b>Paid Total</b></td><td colspan="9"><b><?php echo 'Rs. '.number_format($booking->customerPlotTransactionSum)?></b></td></tr>
                        <tr><td colspan="3"><b>Balance</b></td><td colspan="9"><b><?php echo 'Rs. '.number_format($booking->customPaymentScheduleTotal()-$booking->customerPlotTransactionSum)?></b></td></tr>
                       <?php }?>
                       <tr><td colspan="3"><b>Extra Charges</b></td><td colspan="9"><b><?php echo 'Rs. '.number_format($tpp-$booking->customPaymentScheduleTotal())?></b></td></tr>
