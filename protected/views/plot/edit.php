                    ...
                    <form role="form" method="POST" action="<?php echo Yii::app()->baseUrl?>/plot/update" enctype="multipart/form-data">
                        <!-- <div class="col-lg-12"> -->
                            ...
                            <div class="form-group col-lg-3">
                                ...
                                <select name="size_id" id="size_id" class="form-control" required>
                                    ...
                                    <?php foreach($sizes as $size):?>
                                        ...
                                        <option value="<?php echo $size->id?>" <?php echo (@$plot->size_id == $size->id)?'selected':''?>><?php echo $size->size?></option>
                                    <?php endforeach;?>
                                </select>
                                <!-- <p class="help-block">Example block-level help text here.</p> -->
                            </div>
                            ...
                            <div class="form-group col-lg-6" >
                                ...
                                <input class="form-control" name="discount" id="discount" placeholder="Discount " value="<?php echo @$plot->discount??0.00?>">
                            </div>
                        <!-- </div> -->
                        <div class="col-lg-12">
                            ...
                            <div class="form-group">
                                ...
                                <div class="form-group col-lg-12" >
                                    <label class="checkbox-inline">
                                        <input type="checkbox" name="is_road_facing" id="is_road_facing" value="1" <?php echo (@$plot->is_road_facing == 1)?'checked':''?>>Road Facing
                                    </label>
