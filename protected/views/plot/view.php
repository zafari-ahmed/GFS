    ...
    <div class="col-lg-12">
        <h1 class="page-header">View Plot
            <?php if($plot->customerPlotsCount > 0){?>
                ...
                <?php }?>
            <?php } else{ ?>
            <span class="pull-right hide"><a href="<?php echo Yii::app()->baseUrl?>/booking/add/id/<?php echo $plot->id?>"><button type="button" class="btn btn-success btn-sm">Add Booking</button></a></span>
            <?php } ?>
        </h1>
    </div>
    <!-- /.col-lg-12 -->
        ...
        <div class="panel panel-<?php echo ($plot->status > 0)?'danger':'success'?>">
            ...
            <div class="panel-body">
                <div class="col-lg-12">
                    ...
                    <div class="form-group col-lg-3">
                        <label>Park Facing&nbsp;(<?php echo @$plot->is_park_facing_amount?>%)</label>
                    ...
                    <div class="form-group col-lg-3" style="padding-left: 0px;">
                        <label>Main Boulevard (Rs.<?php echo round(@$plot->is_road_facing_amount,0)?> / SQ Yrd)</label>
                    ...
                    <div class="col-lg-12" style="padding-left: 0px;">
                        <table width="100%" class="table table-striped table-bordered table-hover">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>Road Facing Charges</td>
                                    <?php $roadCharger = $this->Percentage($plotTotal,$plot->is_road_facing_amount,0);?>
                                    <?php $plotTotal = $plotTotal + $roadCharger;?>
                                    <td><?php echo 'Rs. '.$roadCharger?> -> <?php echo number_format($plotTotal)?></td>
                                </tr>
                                <?php } ?>
                                ...
                                <tr>
                                    <td>Park Facing</td>
                                    <?php $parkFacing = $this->Percentage($plot->total,$plot->is_park_facing_amount,0);?>
                                ...
                                <tr>
                                    <td>West Open</td>
                                    <?php $westOpen = $this->Percentage($plot->total,$plot->is_west_open_amount,0);?>
