...
<body>
    <div class="main container">
        <div class="container content" >
            ...
            <div style="position: absolute;top: 21%;left: 76%;"><b><?php echo date('d M, o')?></b></div>
            
            <?php if($duplicate==1){?>
            <div style="text-align: center;border: 2px solid #000;border-radius: 5px;margin-left: 35%;position: absolute;top: 7%;font-size: 30px;padding: 10px;font-weight: bold;">Duplicate</div>
            <?php } ?>
            <br>
            <br>
            ...
            <br>
            <br>
            Kindly note, this reservation does not confer any right or title on the said plot it may be changed or
